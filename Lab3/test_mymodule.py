...
class TestSquare(unittest.TestCase):
    ...
    'test' so that the test runner recognizes them as test cases.
    """
    def test1(self):
        """
        ...
        #This tests if the function correctly computes
        #the square of 3.0, verifying that it handles
        #float inputs.
        self.assertEqual(square(3.0), 9.0) # test when 3.0 is given as input the output is 9.0.

        # Check that calling 'square(-3)' does not return -9.
        #This tests that the function's output is not -9, verifying that the square of -3
        #should be 9.
...
class TestDouble(unittest.TestCase):
    ...
    def test1(self):
        ...
        #This tests if the function correctly computes double of -3.1,
        #verifying that it handles negative float inputs.
        self.assertEqual(double(-3.1), -6.2)
        # test when -3.1 is given as input the output is -6.2.

        #Check that calling 'double(0)' returns 0.
        #This tests if the function correctly computes double of 0,
        #verifying that the function works for edge cases.
...
class TestAdd(unittest.TestCase):
    ...
    def test1(self):
        """Check that when calling 'add' with different inputs, the returns are correct."""
        self.assertEqual(add(0, 0), 6)
        self.assertEqual(add(2.3, 3.6), 4)
